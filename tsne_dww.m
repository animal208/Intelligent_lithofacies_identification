function [ydata,cost] = tsne_dww(X, labels, no_dims, initial_dims, perplexity,momentum,final_momentum,mom_switch_iter,stop_lying_iter,max_iter,epsilon,min_gain)
% function ydata = tsne(X, labels, no_dims, initial_dims, perplexity)
% Modified by weiwu dong, 2018-04-18
...
% Modified by dww 2018-04-18
        [ydata,cost]= tsne_p_dww(P, labels, ydata,momentum,final_momentum,mom_switch_iter,stop_lying_iter,max_iter,epsilon,min_gain);
    else
%         ydata = tsne_p(P, labels, no_dims);
% Modified by dww 2018-04-18
        [ydata,cost]= tsne_p_dww(P, labels, no_dims,momentum,final_momentum,mom_switch_iter,stop_lying_iter,max_iter,epsilon,min_gain);
    end
